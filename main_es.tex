...
\begin{figure}[H]
    ...
    \IfFileExists{#1}
        ...
        {\fbox{\parbox[c][38mm][c]{#2\linewidth}{\centering Marcador de posición:\\ \texttt{\detokenize{#1}}}}}
    \caption{#3}
    \label{#4}
\end{figure}
}
...
\begin{figure*}[t!]
    ...
    \IfFileExists{#1}
        ...
        {\fbox{\parbox[c][45mm][c]{#2\textwidth}{\centering Marcador de posición:\\ \texttt{\detokenize{#1}}}}}
    \caption{#3}
    \label{#4}
\end{figure*}
}
...
\articlefigure{output/simple_sbm_comparison.png}{0.95}{Red espacial agregada original y proyectada. La red original contiene bloques sociales, hubs y bloques no sociales. La red proyectada elimina los hubs y los reemplaza por enlaces efectivos entre bloques.}{fig:network_projection}
...
\articlefigure{output/infectados_mu_small_vs_mu_infty.png}{0.95}{Dinámica de infección bajo regímenes espaciales restrictivos y más libres. Una mezcla espacial más libre produce un pico de infección sustancialmente más alto y temprano.}{fig:spatial_curves}
...
\articlefigure{output/ai_sbm/comparativa_corta_distancia.png}{0.92}{Comparación del subrogado en el régimen de corta distancia.}{fig:short_distance_comparison}
\articlefigure{output/ai_sbm/comparativa_larga_distancia.png}{0.92}{Comparación del subrogado en el régimen de larga distancia.}{fig:long_distance_comparison}
\articlefigure{output/ai_sbm/boxplot_errores_modelos.png}{0.92}{Distribución de errores de los modelos subrogados en los regímenes de corta y larga distancia. El LSTM muestra la distribución de error más pequeña y estable.}{fig:error_boxplot}
...
\articlefigure{output/ai_sbm/english/combined_wave_winter_fit.png}{0.92}{Ajuste empírico del subrogado y del modelo SBM a los datos de monitoreo de COVID-19 de San Petersburgo, invierno de 2022.}{fig:combined_fit}
